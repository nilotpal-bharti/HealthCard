...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("THE PATIENT'S BOOK");

        jLabel5.setIcon(new javax.swing.ImageIcon("E:\\images\\logo.PNG")); // NOI18N

        jLabel6.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(204, 255, 255));
        jLabel6.setText("ELECTRONIC MEDICAL RECORD SYSTEM");

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 255, 255));
        jLabel7.setText("A Powerful, yet easy to");

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(204, 255, 255));
        jLabel8.setText("use application for");
        ...
        jButton1.setBounds(850, 430, 100, 25);
        ...
        jButton2.setBounds(850, 490, 100, 25);

        jPasswordField1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(jPasswordField1);
        jPasswordField1.setBounds(890, 350, 210, 29);

        jLabel11.setIcon(new javax.swing.ImageIcon("E:\\images\\wallpaper-802223.jpg")); // NOI18N
        getContentPane().add(jLabel11);
        jLabel11.setBounds(550, -130, 820, 1390);
...
signUp obj1 = new signUp();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      try
      {
          ...
          String qry ="Select * from signin where emailid='"+id+"'and password='"+pass+"'";
          ResultSet rs = smt.executeQuery(qry);
          if(rs.next())
          {
              doctor obj = new doctor(id);
              obj.setVisible(true);
              this.setVisible(false);
          }
          else
          {
              JOptionPane.showMessageDialog(null, "INVALID DOCTOR ID OR PASSWORD!!!!");
          }
      }catch (Exception ex)
              {
